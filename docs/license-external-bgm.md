# External Background Music Licensing Agreement for Welcome To Hell
...
*   The music may be included in the game's files and uploaded to Roblox as
    required for functionality
*   The music may be looped, trimmed, or lightly edited for in-game use, with
    no major alterations without permission from You
*   The music may be used across both Game content and community-specific
...
*   You are the original creator of the music or have full rights to license it
*   The music does not infringe on third-party rights
*   You have the authority to grant permission for use in a game and
    redistribution

## 4. Attribution

Attribution includes, but is not limited to:

*   Song name and creator attributed on the user interface of the current
    background music 
*   Song name and creator attributed as an alert for the first time a song is
    played during a session
*   Acknowledged under the Game's credits
...
If You wish to revoke permission in the future, please contact us.

Removal will apply to future versions of the game and does not require
retroactive removal from versions already published.
